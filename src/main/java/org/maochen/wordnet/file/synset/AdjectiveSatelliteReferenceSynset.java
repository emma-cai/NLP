 ...
 */
package org.maochen.wordnet.file.synset;

import org.maochen.wordnet.AdjectiveSynset;
import org.maochen.wordnet.AdjectiveSatelliteSynset;
import org.maochen.wordnet.Synset;
import org.maochen.wordnet.SynsetType;
import org.maochen.wordnet.WordNetException;

import org.maochen.wordnet.file.RelationshipPointers;
import org.maochen.wordnet.file.RetrievalException;
import org.maochen.wordnet.file.SenseIndexEntry;
import org.maochen.wordnet.file.SenseIndexReader;
import org.maochen.wordnet.file.SenseKey;
import org.maochen.wordnet.file.SynsetFactory;
import org.maochen.wordnet.file.WordPositions;
		...
		implements AdjectiveSatelliteSynset
{
	...
	/**
	 * Indicates whether this is a head synset or a satellite synset.
	 * Instances of this class always return <code>false</code>.
	 * 
	 * @return <code>true</code> if this a head synset or
	 *         <code>false</code> if it is a satellite synset. 
	 * @throws WordNetException An error occurred retrieving data.
	 * @see    #getHeadSynset()
	 * @see    #getSimilar()
	 */
