...
import org.maochen.wordnet.impl.RandomAccessReader;
...
public class SynsetReader extends RandomAccessReader
{
	 ...
	 */
	private final static ResourceBundle FILE_NAMES = ResourceBundle.getBundle(SynsetReader.class.getName());
	...
	private static File getFile(SynsetType type)
	{
		...
		String dir = PropertyNames.DATABASE_DIRECTORY;
